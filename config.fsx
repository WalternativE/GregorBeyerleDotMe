...
let scssPredicate (projectRoot: string, page: string) =
    page.Contains "main.scss"

let config = {
    Generators = [
        {Script = "sass.fsx"; Trigger = OnFilePredicate scssPredicate; OutputFile = ChangeExtension "css" }
